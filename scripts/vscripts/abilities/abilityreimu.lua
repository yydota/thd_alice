...
REIMU01_GRAVITY = 100
REIMU01_Interval = 0.02
REIMU01_Times = 3
REIMU01_StartHeight = 450
REIMU01_Bounce = 0.9
...
function AbilityReimu:OnReimu01Start(keys)
	...
	if ballunit then
		...
		local vec3 = Vector(targetPoint.x,targetPoint.y,ballunit.tReimu01Elements.OriginZ+REIMU01_StartHeight)
	...
	ballunit:SetContextThink("OnReimu01Release",
		function ()
			...
			if uz <= ballunit.tReimu01Elements.OriginZ+80 then	
				...
				ballunit.tReimu01Elements.Ball.v = ballunit.tReimu01Elements.Ball.v *-REIMU01_Bounce
			...
			if ballunit.tReimu01Elements.Ball.t >= REIMU01_Times then
