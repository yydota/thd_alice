function OnMomiji01Spawn(keys)
	...
	for i=1,count do
		...
		if FindTelentValue(caster,"special_bonus_unique_lycan_1") == 1 then 
			...
			unit:RemoveAbility("ability_system_criticalstrike")
			unit:RemoveModifierByName("modifier_system_attack")
			unit:AddAbility("ability_system_criticalstrike_2")
			ability = unit:FindAbilityByName("ability_system_criticalstrike_2")
			ability:SetLevel(1)
			...
			ability = caster:FindAbilityByName("ability_system_criticalstrike_2")
			ability:SetLevel(1)
		end
